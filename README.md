В этой программе реализовано большое количество сортировок: пузырьковая сортировка, сортировка обычными и двоичными вставками, сортировка выбором(selection sort). 
